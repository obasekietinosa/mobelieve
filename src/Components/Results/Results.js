    ...
    componentDidMount() {
        ...
        switch (true) {
            case score == 3:
                ...
                title = "Sucre Papi"
                grade = "Sucre Papi"
                description = "You'll buy anything for your baby. Anything to make her feel and look special. You are very particular about physical appearance because you always want to show your baby off your friends. 'When you are with the Sucre Papi, you need to look like money', you would say."
                buyButton = <a href="" className="btn btn-secondary waves-effect waves-light">Buy Merchandise</a>
                break;
